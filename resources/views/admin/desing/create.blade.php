...
<x-ui.bredcrumb :items="[
    ...
    ['url' => '', 'label' => 'Crear Plan']  {{-- Último elemento desactivado --}}
]" />
...
<div class="bg-light-200 dark:bg-cont-100 p-5 rounded-lg">
  <div class="">
    <div class="">
      <h3 class="text-3xl font-bold">Crear Plan</h3>
    </div>
    <div class="mt-5">
      <form action="{{ route('admin.plans.store') }}" method="POST" noValidate class="space-y-3"
        >
        @csrf
        <div>

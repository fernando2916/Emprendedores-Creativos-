...
<x-ui.bredcrumb :items="[
    ...
    ['url' => '', 'label' => 'Crear Post']  {{-- Último elemento desactivado --}}
]" />
      ...
      <form action="{{ route('admin.blogs.store') }}" method="POST" noValidate class="space-y-3"
        ...
        <div>
          <label for="name" class="font-medium mb-2 after:ml-0.5 after:text-red-500 after:content-['*']">Descripción
            Corta</label>
          <input id="name" name="descripcion_corta" value="{{ old('descripcion_corta') }}" type="text"
        ...
        <div>
          <label for="name" class="font-medium mb-2 after:ml-0.5 after:text-red-500 after:content-['*']">Tiempo de
            lectura</label>
          <input id="name" name="tiempo_de_lectura" value="{{ old('tiempo_de_lectura') }}" type="text"

...
<x-ui.bredcrumb :items="[
    ['url' => route('admin.sesion.index'), 'label' => 'Portafolio', 'navigate' => true],
    ['url' => '', 'label' => 'Crear Foto']  {{-- Último elemento desactivado --}}
]" />
...
<div class="bg-light-200 dark:bg-cont-100 p-5 rounded-lg">
  <div class="">
    <div class="">
      <h3 class="text-3xl font-bold">Crear Foto</h3>
    </div>
    <div class="mt-5">
      <form action="{{ route('admin.sesion.store') }}" method="POST" noValidate class="space-y-3"

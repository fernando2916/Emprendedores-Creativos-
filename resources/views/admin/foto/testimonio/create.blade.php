        ...
        <div class="">
          ...
          @enderror">
                ...
                <div>
                    ...
                    <input id="name" name="autor" value="{{ old('autor') }}" type="text" placeholder="Autor del testimonio" class="disabled:bg-nav-900 disabled:border-nav-900 border-link-100 focus:shadow-link-200 w-full rounded-md border-2 bg-transparent p-2 outline-none focus:shadow-md placeholder:text-slate-900 dark:placeholder:text-slate-400 mt-2 @error('autor')
          dark:border-alerts-500
          @enderror">
                    @error('autor')
                ...
                <div>
                    ...
                    <input id="name" name="red_social" value="{{ old('red_social') }}" type="text" placeholder="Facebook, X-Twitter, Instagram" class="disabled:bg-nav-900 disabled:border-nav-900 border-link-100 focus:shadow-link-200 w-full rounded-md border-2 bg-transparent p-2 outline-none focus:shadow-md placeholder:text-slate-900 dark:placeholder:text-slate-400 mt-2 @error('expira_en')
          dark:border-alerts-500
          @enderror">
                    @error('expira_en')
                ...
                <button type="submit"
                    class="bg-btn-200 hover:bg-btn-400 dark:bg-btn-400 text-white dark:hover:bg-btn-600 duration-300 transition-colors rounded-md px-3 py-2 w-full cursor-pointer">Crear
                    testimonio</button>
            </form>
        </div>
    </div>

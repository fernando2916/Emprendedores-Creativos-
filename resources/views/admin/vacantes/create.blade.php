...
<x-ui.bredcrumb :items="[
    ...
    ['url' => '', 'label' => 'Crear Vacante']  {{-- Último elemento desactivado --}}
]" />
    ...
    <div class="mt-5">
      <form action="{{ route('admin.vacante.store') }}" method="POST" noValidate class="space-y-3">
        ...
        <div>
          ...
          <input id="modalidad" name="modalidad" value="{{ old('modalidad') }}" type="text"
        ...
        <div>
          ...
          <input id="horario" name="horario" value="{{ old('horario') }}" type="text" placeholder="Horario laboral"
        ...
        <div>
          ...
          <input id="empresa" name="empresa" value="{{ old('empresa') }}" type="text" placeholder="Empresa"
        ...
        <div>
          ...
          <input id="salario" name="salario" value="{{ old('salario') }}" type="text" placeholder="Salario del empleo"
        ...
        <div>
          ...
          <input id="postulacion" name="postulacion" value="{{ old('postulacion') }}" type="date"
            placeholder="Último dia para postularse" class="disabled:bg-nav-900 disabled:border-nav-900 border-link-100 focus:shadow-link-200 w-full rounded-md border-2 bg-transparent p-2 outline-none focus:shadow-md placeholder:text-slate-300 dark:placeholder:text-slate-400 mt-2 @error('postulacion')
          dark:border-alerts-500
          @enderror">
          @error('postulacion')

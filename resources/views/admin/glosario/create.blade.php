...
<x-ui.bredcrumb :items="[
    ...
    ['url' => '', 'label' => 'Crear Definición']  {{-- Último elemento desactivado --}}
]" />
...
<div class="bg-light-200 dark:bg-cont-100 p-5 rounded-lg">
  <div class="">
    <div class="">
      <h3 class="text-3xl font-bold">Crear Definición</h3>
    </div>
    <div class="mt-5">

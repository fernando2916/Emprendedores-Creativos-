...
<div class="w-full flex justify-between items-center max-w-7xl mx-auto">
  ...
  <a href="{{ route('admin.glosario.create') }}" wire:navigate>
    <button
...
<section class="pt-3">
  <div class="mx-auto max-w-7xl">
    ...
    <div class="bg-light-200 dark:bg-cont-100 relative shadow-md rounded-lg overflow-hidden">
            ...
            <tr class="border-b dark:border-gray-700 ">
              ...
              <td class="px-4 py-3 flex items-center justify-start">
                <div class="flex items-center gap-2">                 
                  ...
                  <a href="{{ route('admin.glosario.edit', $glosario) }}" wire:navigate>
                    <button
                  ...
                  <form class="delete-form" action="{{ route('admin.glosario.destroy', $glosario) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
                      class="px-3 py-2 bg-btn-200 hover:bg-btn-400 dark:bg-btn-400 dark:hover:bg-btn-600 transition-colors duration-150 rounded-md cursor-pointer">
      ...
      <div class="m-5">
           {{ $glosarios->links('vendor.pagination.tailwind') }}
        </div>
    </div>
  </div>
</section>

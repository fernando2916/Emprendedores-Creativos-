<nav class="flex items-center gap-2">
  <x-btn-darkmode/>
  <x-cart/>
  <a href="/crear-cuenta" class="hidden lg:block hover:text-link-200 dark:text-link-100 dark:hover:text-link-300 duration-300 transition-colors">Registrarse</a>

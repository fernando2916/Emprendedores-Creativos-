          ...
          <span class="text-gray-200 dark:text-wwhite font-light">
            ...
            {{-- {/* resumen */} --}}
             <div>
              ...
              <p class=" text-justify text-sm md:text-lg pt-2">
              ...
              <div class="my-3">
                <ul class="space-y-5">
                  <li class="flex gap-3">
                    <div>
                    <i class="fa-solid fa-circle mt-1.5 text-xs"></i>
                    </div>
            ...
            <div class="mt-5">
              ...
              <div class="space-y-3 mt-5">
                <p class="text-justify ml-6 md:ml-9">Estos términos y condiciones y los anexos que explican los servicios del Ecosistema MELI (de ahora en más: “Términos y Condiciones”) regulan la relación entre Mercado Libre y las  personas que usan sus servicios (“Personas Usuarias”). </p>
                <p class="text-justify ml-6 md:ml-9">Las Personas Usuarias aceptan estos Términos y Condiciones desde el momento en que se registran en el Sitio y usan el Ecosistema MELI.</p>
                <p class="text-justify ml-6 md:ml-9">Cuando debamos hacer cambios importantes en nuestros servicios, publicaremos las modificaciones con 10 días corridos de anticipación para que las Personas Usuarias puedan revisarlas y seguir usando el Ecosistema MELI. En ningún caso afectarán las operaciones que ya hayan finalizado.</p>
            ...
            <div class="mt-5">
              ...
              <div class="mt-5 space-y-3">
                <p class="text-justify ml-6 md:ml-9">Podrán usar nuestros servicios las personas mayores de edad que tengan capacidad legal para contratar. </p>
            ...
            <div class="mt-5">
              ...
              <div class="mt-5">
                <p class="text-justify ml-6 md:ml-9">
            ...
            <div class="mt-5">
              ...
              <div class="mt-5 space-y-3">
                <p class="text-justify ml-6 md:ml-9">Mercado Libre podrá cobrar por sus servicios y la Persona Usuaria se compromete a pagarlos a tiempo. </p>
                <p class="text-justify ml-6 md:ml-9">Podremos modificar o eliminar las tarifas en cualquier momento con el debido preaviso establecido en la cláusula 2 de estos Términos y Condiciones. De la misma manera, podremos modificar las tarifas temporalmente por promociones en favor de las Personas Usuarias. </p>
                <p class="text-justify ml-6 md:ml-9">La Persona Usuaria autoriza a Mercado Libre a retener y/o debitar los fondos existentes y/o futuros de su cuenta de Mercado Pago y/o de las cuentas bancarias que haya registrado en ella, para saldar las tarifas impagas o cualquier otra deuda que pudiera tener. </p>
                <p class="text-justify ml-6 md:ml-9">Para conocer el detalle de las tarifas de cada servicio, las Personas Usuarias deberán consultar los términos y condiciones correspondientes. </p>
            ...
            <div class="mt-5">
              ...
              <div class="mt-5">
                <p class="text-justify ml-6 md:ml-9">Además de estos Términos y Condiciones, cada servicio del Ecosistema MELI tiene sus propias reglas de uso:  </p>
                <ul class="ml-6 md:ml-9 space-y-3 mt-5">
                  <li class="flex gap-2">
                    <div>
                    <FaCircle class="mt-2.5 text-[7px]" />
                    </div>
                    <h3 class="text-lg text-link-100 hover:text-link-300 duration-150 transition-colors">
                      Emprendedores Foto
                    </h3>
                  </li>
                  <li class="flex gap-2">
